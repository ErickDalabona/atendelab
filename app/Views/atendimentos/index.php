...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        AtendeLabApi.showAlert('alerta', 'Erro ao carregar combos: ' + error.message, 'danger');
    }
    try {
        await carregarAtendimentos();
    } catch (error) {
        AtendeLabApi.showAlert('alerta', 'Erro ao carregar atendimentos: ' + error.message, 'danger');
    }
});
</script>
